<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="yuan.zhang.entity.Page"%>
			...
			<div class="col-xs-9">
				<div class="record_ron">
					...
					<div class="table_box">
						<table id="sample-table-1"
							...
							<tbody>
								<%
									...
									//当前页的页码
									int currentPageIndex = pages.getCurrentPage();
									//获取当前页的Record集合
									List<Record> res = pages.getRecords();
									if (res != null) {
						...
						<table class="tab">
							<tr>
								<td class="td">当前页数：[<%=currentPageIndex%>/<%=totalPages%>]
								</td>
								<td class="td">
									<%
