		...
		<div class="nav_box">
			<div class="container warp">
				<ul class="pull-left">
					...
					<li class="ac"><a href="../views/serve.jsp"> <i
							class="icon iconfont">&#xe634;</i> 服务介绍
					</a></li>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-8 text-center">
					<a href="../views/serve.jsp">服务介绍</a> <a
						href="../views/serve_2.jsp">北斗卫星定位</a> <a
						href="../views/serve_3.jsp" class="ac">汽车增值服务</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container serve_box">
		<div class="row">
			<div class="col-xs-3">
				<div class="serve_lf">
					<ul>
						<li><a href="#" class="ac_s">汽车增值服务</a></li>
						<li><a href="#">全国高速畅行</a></li>
						<li><a href="#">加油专享优惠</a></li>
						<li><a href="#">多家车险折扣</a></li>
					</ul>
				</div>
			</div>
			<div class="col-xs-9">
				<div class="serve_ron">
					...
					<p>接力救援、无限次、非事故车救援
						...
						*以上道路救援服务根据客户所选择的不同保险协作公司而定</p>
					<img src="../images/e6.jpg" />

					<h3>六、法律咨询免费服务</h3>
					<p>免费咨询、高达20%律师费补助
						多家知名律师事务所提供专享VIP客户免费法律咨询援助服务；递交诉状打官司可独享20%律师费补助。</p>
					<img src="../images/e7.jpg" />

					<h3>七、机油、轮胎、维修等服务</h3>
					<p>机油专享价省10%、厂家直供、免费送货
						多家知名机油供应商集团购价格，包括长城，嘉实多，壳牌等；大客户提供预约免费送货上门服务；轮胎、维修等服务近期即将对外推放。</p>
					<img src="../images/e8.jpg" />

					<h3>八、中国银行金盾网联信用卡特色功能</h3>
					<p>无年费、金融IC卡、借贷合一、取现无手续费、缴违章罚款
