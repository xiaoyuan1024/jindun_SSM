			...
			<div class="container warp">
				<ul class="pull-left">
					...
					<li>
						...
						%> <a
						href="<%=basePath%>record/selectRecord?username=<%=username%>"><i
							class="icon iconfont">&#xe66c;</i> 通行记录 </a>
					</li>
					<div class="clear"></div>
				</ul>
			...
			<div class="row">
				...
				<div class="col-xs-8 text-center">
					<a href="../views/serve.jsp">服务介绍</a> <a
						href="../views/serve_2.jsp" class="ac">北斗卫星定位</a> <a
						href="../views/serve_3.jsp">汽车增值服务</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container serve_box">
		<div class="row">
			<div class="col-xs-3">
				<div class="serve_lf">
					<ul>
						<li><a href="#" class="ac_s">北斗卫星定位</a></li>
						<li><a href="#">部标北斗卫星定位</a></li>
						<li><a href="#">全国货运平台</a></li>
						<li><a href="#">北斗车联网</a></li>
					</ul>
				</div>
			</div>
			<div class="col-xs-9">
				<div class="serve_ron">
					...
					<p>简介
						...
						北斗一号系统的基本功能包括：定位、通信（短消息）和授时。 北斗二代系统的功能与GPS相同，即定位与授时。 系统工作原理
